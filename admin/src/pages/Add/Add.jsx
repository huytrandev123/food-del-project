...
const Add = () => {
  ...
  const onChangeHandler = e => { 
    ...
    const value = e.target.value // value from user type
    setData(data => ({...data, [name]: value}))
  }

  const onSubmitHandler = async e => { 
    e.preventDefault()
    // Received data from submit form
    ...
    // Send form date to endpoint = call api Axios
      ...
      <form className='flex-col' onSubmit={onSubmitHandler} action="">
        ...
        <div className="add-category-price">
          ...
          <div className="add-price flex-col">
            <p>Product Price</p>
            <input onChange={onChangeHandler}  type="number" name='price' placeholder='10.000' />
          </div>
        </div>
